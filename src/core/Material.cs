...
namespace RayTracer
{
    ...
    public class Material
    {
        ...
        private double percentReflected;
        ...
        public Material(MaterialType type, Color color, double refractiveIndex = 1, double percentReflected = 1)
        {
            this.type = type;
            this.color = color;
            this.refractiveIndex = refractiveIndex;
            this.percentReflected = percentReflected;
        }
        ...
        public double PercentReflected { get { return this.percentReflected; } }
    }
}
